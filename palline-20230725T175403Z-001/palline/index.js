...
const startGameb =document.querySelector('#startGameb')
...
let score=0;
function animate(){
    aniamtionId=requestAnimationFrame(animate);
    ...
    enemies.forEach((enemy,index)=> {
      ...
      cancelAnimationFrame(aniamtionId);
      ...
      projectiles.forEach((projectile,projectileIndex)=> {
        ...
        if(dist - enemy.radius - projectile.radius < 1){
            ...
            for(let i=0;i<8;i++){
              particles.push(new Particle(projectile.x,projectile.y,Math.random()*6,enemy.color,{
